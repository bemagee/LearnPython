...
# doesn't work in python 2.* print("I don't like ", end="")
...
# error for python3: test_file.write(bytes("Write me to the file\n"))
...
# Error: spot = Dog("Spot", 53, 27, "Ruff", "Derek")
spot = Dog("Spot", 53, 27, "Ruff", "dd")
...
=======
spot.multiple_sounds(4)
>>>>>>> 5b536b86c96881b3014d88123e7d0fc9fc7d3248
